...
<%@ include file="../header.jsp"%>
	...
	<div class="container">
		<div class="board_view">
			<h2>${view.title }</h2>
			<p class="info"><span class="user">${view.writer}</span> | <fmt:formatDate value="${view.regdate }" pattern="yyyy-MM"/> | <i class="fa fa-eye"></i> ${view.viewcount}</p>
			<div class="board_body">
				<p>${view.content }</p>
<img src="${pageContext.request.contextPath}/upload/${view.imgurl}" alt="포트폴리오 사진">
			</div>
			<div class="prev_next">
