	...
	<div class="container">
	  ...
	  <div class="bord_list">
		...
		<c:forEach var="list" items="${plist}">
			<li>
				<span class="date">
					<em><fmt:formatDate value="${list.regdate }" pattern="dd"/></em><!-- Date 타입 서식 지정 -->
					<fmt:formatDate value="${list.regdate }" pattern="yyyy-MM"/>
				</span>
				<div class="text_wrap">
					<div class="img_wrap">
						 
						<img src="/upload/${list.imgurl}" alt="">
					</div>
					<span class="info">
						<span class="blue_text">No. ${list.bno }</span>
						<i class="bar"></i>
		...
		<div class="paging">
			...
			<a href="portfoliowrite.do" class="btn_write">글쓰기</a>
		</div>
	  </div>
	</div>
	<!-- end contents -->
